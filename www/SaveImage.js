...
ImageSaver.saveImageToGallery = function (localImagePath, myGalleryName, successCallback, failureCallback) {
    ...
    return cordova.exec(
        successCallback, failureCallback, 'SaveImage', 'saveImageToGallery', [_getLocalImagePathWithoutPrefix(), myGalleryName]);
